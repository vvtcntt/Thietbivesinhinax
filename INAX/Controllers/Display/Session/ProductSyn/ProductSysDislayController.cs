...
using INAX.Models;
namespace INAX.Controllers.Display.Session.ProductSyn
{
    public class ProductSysDislayController : Controller
    {
        ...
        public PartialViewResult ListProductSyn()
        {
            ...
            chuoi += "<div id=\"ProductDB\">";
            chuoi += "<div id=\"nVar_ProductDB\">";
            chuoi += "<span> Sản phẩm đồng bộ</span>";
            chuoi += "</div>";
            chuoi += "<div id=\"Adw_sbdb\">";
            ...
            { 
            chuoi += "<div id=\"Content_ProductDB\">";
        ...
        public ActionResult ProductSyn_Detail(string tag)
        {
            ...
            if(Product.Count>0)
            {
                ...
                chuoipr += "<span class=\"tinhnang\">Danh sách sản phẩm có trong " + tblproductSyn.Name + "</span>";
                ...
                chuoisosanh += "</tr>";
                     ...
                     for (int i = 0; i < Product.Count; i++)
                     {
                         ...
                         chuoipr += "<h2><a href=\"/" + Productdetail[0].Tag + "-dt\" title=\"" + Productdetail[0].Name + "\">" + Productdetail[0].Name + "</a></h2>";
                         chuoipr += "</div>";
                         chuoipr += "<div class=\"img_syn\">";
                         chuoipr += "<a href=\"/" + Productdetail[0].Tag + "-dt\" title=\"" + Productdetail[0].Name + "\"><img src=\"" + Productdetail[0].ImageLinkThumb + "\" alt=\"" + Productdetail[0].Name + "\" /></a>";
                         chuoipr += "</div>";
                         chuoipr += "</div>";
                         chuoipr += "</div>";
                         ...
                         chuoisosanh += "<td style=\"width:20%;text-align:center\">" + string.Format("{0:#,#}", Productdetail[0].PriceSale) + " (A/P khi liên hệ, không áp dụng trên web)</td>";
                         chuoisosanh += "<td style=\"text-align:center; width:20%\">" + string.Format("{0:#,#}", Productdetail[0].PriceSale) + "(A/P khi liên hệ, không áp dụng trên web)</td>";
                         chuoisosanh += " </tr>";
                 ...
                 chuoisosanh += "<td style=\"font-weight:bold; font-size:16px; text-align:center\">" + string.Format("{0:#,#}", Convert.ToInt32(tonggia)) + " đ (A/P khi liên hệ, không áp dụng trên web)</td>";
                 chuoisosanh += "</tr>";
                 chuoisosanh += "<tr>";
        ...
        public PartialViewResult RightProductSyn(string tag)
        {
            ...
            //Load sản phẩm liên quan
             string chuoiproduct = "";
            var listProduct = db.tblProductSyns.Where(p => p.Active == true ).OrderBy(p => p.Ord).Take(7).ToList();
            for (int i = 0; i < listProduct.Count; i++)
            {

                chuoiproduct += "<div class=\"Tear_pd\">";
                chuoiproduct += "<div class=\"img_Tearpd\">";
                chuoiproduct += "<a href=\"/Syn/" + listProduct[i].Tag + "\" title=\"\"><img src=\"" + listProduct[i].ImageLinkThumb + "\" alt=\"" + listProduct[i].Name + "\" /></a>";
                chuoiproduct += "</div>";
                ...
                chuoiproduct += "<div class=\"box_quatang1\">";
                chuoiproduct += "</div>";
                chuoiproduct += "<a class=\"Namepd\" href=\"/Syn/" + listProduct[i].Tag + "\" title=\"" + listProduct[i].Name + "\">" + listProduct[i].Name + "</a>";
                chuoiproduct += "<p class=\"PriceSale\">" + string.Format("{0:#,#}", listProduct[i].PriceSale) + " <span>đ</span></p>";
                chuoiproduct += "<p class=\"Price_s\">" + string.Format("{0:#,#}", listProduct[i].Price) + "đ</p>";
                ...
                if (listProduct[i].Transport == true)
                {
        ...
        {
            ViewBag.Title = "<title> Danh sách sản phẩm inax đồng bộ - Khuyến mại lớn !</title>";
            ViewBag.Description = "<meta name=\"description\" content=\"Danh sách những sản phẩm inax đồng bộ áp dụng khuyến mại dành cho khách hàng khi mua thiết bị vệ sinh Inax\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"Sản phẩm inax đồng bộ, thiết bị vệ sinh inax đồng bộ\" /> ";
