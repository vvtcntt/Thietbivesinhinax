...
namespace INAX.Controllers.Display.Session.Baogia
{
    public class BaogiaController : Controller
    {
        ...
        public ActionResult BaogiaDetail(string tag, int? page)
        {
            ...
            ViewBag.Date = "<span class=\"date1\">Hà Nội, ngày " + DateTime.Now.Day + " tháng " + DateTime.Now.Month + " năm " + DateTime.Now.Year + "</span>";
