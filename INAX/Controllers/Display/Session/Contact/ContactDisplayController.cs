...
using System.Web.Mvc;
 using INAX.Models;
using System.Net;
namespace INAX.Controllers.Display.Session.Contact
{
    public class ContactDisplayController : Controller
    {
        //
        // GET: /ContactDisplay/
        ...
        public ActionResult Index(tblContact Contact, FormCollection collection)
        {
            ...
            string subject = "Bạn có liên hệ mới từ  Thietbivesinhinax.vn: ";
