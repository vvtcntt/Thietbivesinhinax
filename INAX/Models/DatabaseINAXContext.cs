...
using INAX.Models.Mapping;

namespace INAX.Models
{
    public partial class DatabaseINAXContext : DbContext
    {
        static DatabaseINAXContext()
        {
            Database.SetInitializer<DatabaseINAXContext>(null);
        }

        public DatabaseINAXContext()
            : base("Name=DatabaseINAXContext")
        {
        }
